...
window.onload = function () {
        ...
        let oBox = document.getElementById("box"); //商品列表所在的div
        let oUl = document.getElementsByTagName("ul")[0]; //商品列表所在的ul
     ...
     /*     第二步：给添加购物车按钮添加事件
        ...
        */
        ...
        //获取所有的数量减号按钮
        let d_btn = document.getElementsByClassName("count_d");
        ...
        //获取删除按钮，并添加事件
        let delBtn = oDiv.lastChild.getElementsByTagName("a")[0];
                                delBtn.onclick = function() {
                                    let result = confirm("确定删除吗Êtes-vous sûr de le supprimer?");
                                    if (result) {
...
let index = false;
            function checkAll() {
                let choose = document.getElementById("car").getElementsByTagName("i");
                // console.log(choose);
                if (choose.length != 1) {
            ...
            //获取选中框
            let check = oDiv.firstChild.getElementsByTagName("i")[0]; //????[0]???
             ...
             /* 第七步：动态更新总价 */
                                    ...
                                    function getAmount() {
                                        ...
                                        for (y = 0; y < ns.length; y++) {
                                            ...
                                            numElement = parseInt(amount_info.innerText);
                                            sum += numEment;
                                            document.getElementById("price_num").innerText = sum;
                                        }
                                    }